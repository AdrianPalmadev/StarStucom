...
public class CrearKlingon extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public CrearKlingon(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.ipadx = 20;
        getContentPane().add(fuerza, gridBagConstraints);

        crearferengi.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        crearferengi.setText("Alta Klingon");
    ...
    private void crearferengiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_crearferengiActionPerformed
        ...
        Ser s = new Klingon(levelfuerza, name);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CrearKlingon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CrearKlingon dialog = new CrearKlingon(new javax.swing.JDialog(), true);
